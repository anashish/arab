...
implements DatePickerDialog.OnDateSetListener {
    ...
    public DatePickerFragment(int Cal_Type, boolean startFromCurrentDate){
...
/*                    for (Field datePickerField : datePickerFields) {
                       if ("mYearPicker".equals(datePickerField.getName())|"mYearSpinner".equals(datePickerField.getName()) |"mMonthSpinner".equals(datePickerField.getName()) |"mMonthPicker".equals(datePickerField.getName())) { //mDayPicker
...
public void onDateSet(DatePicker view, int year, int month, int day) {
	...
	//AppUtility.SOUT(" Day = "+day+" Month = "+month+" Year = "+year);

	this.listener.onDateSet(year, month, day, this.Cal_Type);
  //  mListener.onDateSett(year, month, day);
}
